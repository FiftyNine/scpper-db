...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE FUNCTION `CI_LOWER_BOUND`(Positive INT, Negative INT) RETURNS float DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE PROCEDURE `ADD_SITE`(in ASiteId int, in ACategoryId int, in AEnglishName varchar(256), in ANativeName varchar(256), in AShortName varchar(10), in AWikidotName varchar(256), in ADomain varchar(256), in ADefaultLanguage varchar(10), in AProtocol varchar(5))
BEGIN
 INSERT INTO sites (WikidotId, EnglishName, NativeName, ShortName, WikidotName, Domain, DefaultLanguage, Protocol) VALUES (ASiteId, AEnglishName, ANativeName, AShortName, AWikidotName, ADomain, ADefaultLanguage, AProtocol);
